...
export default function Page() {
  return (
    <div className="relative flex min-h-svh w-full items-center justify-center overflow-hidden bg-[#f3f0e8] p-6 md:p-10">
      ...
      <div className="absolute -left-32 top-12 size-96 rounded-full bg-amber-300/30 blur-3xl" />
