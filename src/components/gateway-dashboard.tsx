...
import { CopyIcon, LockKeyholeIcon, PencilIcon, PlusIcon, RouteIcon, Trash2Icon } from "lucide-react"
...
export function GatewayDashboard({ view }: { view: "endpoint-key" | "providers" | "models" | "settings" }) {
