...
export function SiteHeader() {
  ...
  const title = pathname === "/dashboard/providers" ? "Providers" : pathname === "/dashboard/models" ? "Models" : pathname === "/dashboard/logs" ? "Console Log" : pathname === "/dashboard/settings" ? "Settings" : "Endpoint & Key"
