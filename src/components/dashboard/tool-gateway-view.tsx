...
export function ToolGatewayView({ page }: { page: ToolGatewayPage }) {
  ...
  return <main className="flex-1 bg-[#f6f5f1] p-4 dark:bg-background md:p-6 lg:p-8">
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2"><CardTitle>Executor integration</CardTitle><Badge variant="secondary">API-only</Badge><Badge variant="outline">Shared deployment</Badge></div>
