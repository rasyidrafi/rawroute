...
test("providers use a list page and a dynamic detail page", () => {
  ...
  expect(codexPage).toContain("OAuthProvidersView")
  expect(codexPage).not.toContain('ProviderDetailView providerId="codex"')
  expect(codexLoading).toContain('variant="oauth-providers"')
})
